...
public class MslApi  {
   ...
   private final MslApiService delegate = MslApiServiceFactory.getMslApi();
    ...
    @io.swagger.annotations.ApiOperation(value = "", notes = "Get the user's library of favorites", response = MyLibrary.class, authorizations = {
        @io.swagger.annotations.Authorization(value = "sessionToken")
    })
    ...
    @ApiParam(value = "Authenticated user session token" ,required=true)@HeaderParam("sessionToken") String sessionToken)
    throws NotFoundException {
        return delegate.commentSong(songId,sessionToken);
    }
    @PUT
    @Path("/v1/ratingsedge/ratealbum/{albumId}")
    @Consumes({ "application/x-www-form-urlencoded" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "", notes = "Update your rating of an album.", response = StatusResponse.class, authorizations = {
        @io.swagger.annotations.Authorization(value = "sessionToken")
    })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response rateAlbum(@ApiParam(value = "Id for the album that is being rated",required=true) @PathParam("albumId") String albumId,
    @ApiParam(value = "Value between 1-5 that represents the user's rating of the album", required=true)@FormParam("rating")  BigDecimal rating,
    @ApiParam(value = "Authenticated user session token" ,required=true)@HeaderParam("sessionToken") String sessionToken)
    throws NotFoundException {
        return delegate.rateAlbum(albumId,rating,sessionToken);
    }
    @PUT
    @Path("/v1/ratingsedge/rateartist/{artistId}")
    @Consumes({ "application/x-www-form-urlencoded" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "", notes = "Update your rating of an album.", response = StatusResponse.class, authorizations = {
        @io.swagger.annotations.Authorization(value = "sessionToken")
    ...
    public Response rateArtist(@ApiParam(value = "Id for the artist that is being rated",required=true) @PathParam("artistId") String artistId,
    @ApiParam(value = "Value between 1-5 that represents the user's rating of the artist", required=true)@FormParam("rating")  BigDecimal rating,
    @ApiParam(value = "Authenticated user session token" ,required=true)@HeaderParam("sessionToken") String sessionToken)
    throws NotFoundException {
        return delegate.rateArtist(artistId,rating,sessionToken);
    }
    @PUT
    ...
    @ApiParam(value = "Authenticated user session token" ,required=true)@HeaderParam("sessionToken") String sessionToken)
    throws NotFoundException {
        return delegate.rateSong(songId,rating,sessionToken);
    }
    @GET
