...
public class ApiApiServiceImpl extends ApiApiService {
    ...
    @Override
    public Response browseArtists(String pos, Integer items, String facets, String sortFields)
            throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    ...
    @Override
    public Response browseSongs(String pos, Integer items, String facets, String sortFields)
            throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
