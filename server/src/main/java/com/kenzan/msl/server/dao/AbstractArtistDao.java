 ...
 * 
 *  NOTE: It would be nice to define here the columns that all Artist DAOs have in common. Unfortunately
 *  		the Datastax Mapper does not reflect on super classes when mapping result rows to DAOs.
 *
