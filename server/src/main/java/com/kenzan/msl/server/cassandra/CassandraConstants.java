...
public class CassandraConstants {
	...
	public static enum MSL_CONTENT_TYPE {
		ALBUM	(FeaturedAlbumsDao.class,	AlbumsByFacetDao.class),
		ARTIST	(FeaturedArtistsDao.class,	ArtistsByFacetDao.class),
		SONG	(FeaturedSongsDao.class,	SongsByFacetDao.class);
