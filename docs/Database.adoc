...
|Q1				|Users					|image:images/Q01 users.png[Users]
|Q2				|User Data by User		|image:images/Q02 user data by user.png[User Data by User]
|Q3				|Average Ratings		|image:images/Q03 average ratings.png[Average Ratings]
|Q4				|Featured Songs			|image:images/Q04 featured songs.png[Featured Songs]
|Q5				|Songs by Facet			|image:images/Q05 songs by facet.png[Songs by Facet]
|Q6				|Featured Songs			|image:images/Q06 featured songs.png[Featured Songs]
|Q7				|Songs by Facet			|image:images/Q07 albums by facet.png[Songs by Facet]
|Q8				|Featured Artists		|image:images/Q08 featured artists.png[Featured Artists]
|Q9				|Artists by Facet		|image:images/Q09 artists by facet.png[Artists by Facet]
|Q10			|Songs/Albums by Artist	|image:images/Q10 songs albums by artist.png[Songs/Albums by Artist]
|Q11			|Songs by User			|image:images/Q11 songs by user.png[Songs by User]
|Q12			|Albums by User			|image:images/Q12 albums by user.png[Albums by User]
|Q13			|Artists by User		|image:images/Q13 artists by user.png[Artists by User]
|Q14			|Songs/Artist by Album	|image:images/Q14 songs artist by album.png[Songs/Artist by Album]
|Q15			|Album/Artist by Song	|image:images/Q15 album artist by song.png[Album/Artist by Song]
|Q16			|Paging State			|image:images/Q16 paging state.png[Paging State]
|=======================
...
So, at a high level, the data import process uses python to traverses a given directory tree consuming all the .h5 filed and creates a single CSV file with one line for each song. This CSV file is then consumed by a Java program to create the CSVs that will be inserted into the Cassandra cluster.
